...
export const NOTEBOOK = [
  ...
  '<h4>I · SPOTTING A KEY</h4><p>Some of my grids carry one shaded square. It is never a given — it sits empty and waits for you to solve it honestly. The digit that lands in the shade is the key.</p><p>Copy it to the Vault Door Tally (page 210) before you forget. The plates that turn digits into letters are in the back of the book, pages 213 to 215.</p>',
